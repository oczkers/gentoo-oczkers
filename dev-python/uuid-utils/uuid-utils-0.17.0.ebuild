...
QA_FLAGS_IGNORED="usr/lib.*/py.*/site-packages/uuid_utils/.*.so"

EPYTEST_DESELECT=(
	# Network sandbox prevents access to MAC address / network interfaces
	tests/test_uuid.py::test_getnode
)
EPYTEST_IGNORE=(
	# Benchmarks are not functional tests
